...
export const MarkdownRenderer = memo(function MarkdownRenderer({ content, components: componentOverrides, className }: { content: string; components?: Components; className?: string }) {
  const mergedComponents = useMemo(
    () => componentOverrides ? { ...DEFAULT_COMPONENTS, ...componentOverrides } : DEFAULT_COMPONENTS,
    [componentOverrides]
  );
